...
'''
This is the GNU Radio LORA_RTS_CTS module. Place your Python package
...
# import swig generated symbols into the lora_rts_cts namespace
try:
    # this might fail if the module is python-only
    from .lora_rts_cts_swig import *
